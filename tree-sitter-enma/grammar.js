...
module.exports = grammar({
  ...
  rules: {
   ...
   _declaration: ($) => choice(
    ...
    // === Comments (external scanner) ===
    // handled by scanner — no inline rules needed
    ...
    // === Primitive types (each as separate token for keyword extraction) ===
    _type_bool: ($) => token("bool"),
    _type_char: ($) => token("char"),
    _type_wchar: ($) => token("wchar"),
    _type_wchar_t: ($) => token("wchar_t"),
    _type_int8: ($) => token("int8"),
    _type_int16: ($) => token("int16"),
    _type_int32: ($) => token("int32"),
    _type_int64: ($) => token("int64"),
    _type_uint8: ($) => token("uint8"),
    _type_uint16: ($) => token("uint16"),
    _type_uint32: ($) => token("uint32"),
    _type_uint64: ($) => token("uint64"),
    _type_aint8: ($) => token("aint8"),
    _type_aint16: ($) => token("aint16"),
    _type_aint32: ($) => token("aint32"),
    _type_aint64: ($) => token("aint64"),
    _type_float32: ($) => token("float32"),
    _type_float64: ($) => token("float64"),
    _type_string: ($) => token("string"),
    _type_wstring: ($) => token("wstring"),
    _type_void: ($) => token("void"),

    primitive_type: ($) => choice(
      $._type_bool, $._type_char, $._type_wchar, $._type_wchar_t,
      $._type_int8, $._type_int16, $._type_int32, $._type_int64,
      $._type_uint8, $._type_uint16, $._type_uint32, $._type_uint64,
      $._type_aint8, $._type_aint16, $._type_aint32, $._type_aint64,
      $._type_float32, $._type_float64,
      $._type_string, $._type_wstring, $._type_void,
    ),
    ...
    lambda_expression: ($) => seq(
      optional(seq("[", optional(commaSep1(choice($.identifier, seq("&", $.identifier)))), "]")),
    ...
    constructor_definition: ($) => seq(
      field("name", $.identifier),
      "(", optional(commaSep1($.parameter_declaration)), ")",
      optional(seq(":", commaSep1(seq($.identifier, "(", optional(commaSep1($._expression)), ")")))),
      $.compound_statement,
    ),
    ...
    property_declaration: ($) => seq(
      "property", $._type_specifier, field("name", $.identifier), "{",
    ...
    typedef_declaration: ($) => seq(
      "typedef", $._type_specifier, field("alias", $.identifier), ";",
    ),

    using_declaration: ($) => seq(
      "using", field("alias", $.identifier), "=", $._type_specifier, ";",
    ),
    ...
    // === Field declarator (used in variable decls) ===
